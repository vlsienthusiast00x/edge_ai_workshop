...
----
To implement this model using SVM we can use the same LinearSVC macro provided by sklearn library.

<img width="500" alt="image" src="https://github.com/user-attachments/assets/385b27be-b5a1-4997-a65d-9f9e1f512958" />

The above picture is created by matplotlib after providing a sample input data to [mnist_svm.py](codes/mnist_svm.py).
